...
if [ "$color_prompt" = yes ]; then
    ...
    PS1="${cyan}\[\e(0\]lq\[\e(B\](${user_host}${cyan})${light_cyan}-${working_dir}
...
# Add an "alert" alias for long running commands.  Use like so: ###SLEEP 10 WAS DISABLED --twy
#   sleep 10; alert
...
# fix gems on unbuntu, idk for other distro
